...
| research-team → writer-team | verification-loops + cross-model-verification（解耦 judge 防自评偏差）——用「模型家族隔离 / judge 盲审 / 多样本投票」三硬约束，强化 writer-team QA 第一条方法论「AI 自评偏见消除」的硬约束层 |
