...
json_assert agent-system/quality-scoring.policy.json 'data["version"] == "1.2.0"'
json_assert agent-system/quality-scoring.policy.json '"maker_checker_isolation" in data["debiasing"] and data["debiasing"]["maker_checker_isolation"]["required"] is True'
json_assert agent-system/quality-scoring.policy.json '"minimum_sample_size" in data["debiasing"] and data["debiasing"]["minimum_sample_size"]["default"] == 3'
json_assert agent-system/quality-scoring.policy.json '"anti_slop_check" in [r["id"] for r in data["role_gates"]["design"]["rubric_items"]]'
json_assert agent-system/quality-scoring.policy.json '"comprehension_debt_check" in [r["id"] for r in data["role_gates"]["delivery"]["rubric_items"]]'
json_assert agent-system/quality-scoring.policy.json '"context_advantage_layers" in data["qa_framework"] and "anti_slop" in data["qa_framework"]'
json_assert agent-system/quality-scoring.policy.json 'data["qa_framework"]["anti_slop"]["skill"] == "skills/_imported/taste-skill/"'
json_assert agent-system/coordination.policy.json 'data["version"] == "1.2.0"'
json_assert agent-system/coordination.policy.json '"midlayer_review_cadence" in data and data["midlayer_review_cadence"]["default"] == "30m"'
