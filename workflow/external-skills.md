...
> 第三方/外部技能清单（v2.4 版本，含 GitHub 全面调研结果 + 下载状态标注 + 新角色技能索引）。
...
## 十一、标题工程师承载（08-title-engineer）

> 本节为 v2.4 新增，对应 [orchestration.md](orchestration.md) v1.3 的 Step 5.5 标题工程优化。

### 标题工程师（08-title-engineer）
...
## 十二、数据分析师承载（09-data-analyst）

> 本节为 v2.4 新增，对应 [orchestration.md](orchestration.md) v1.3 的 Step 13 发布后数据闭环。

### 数据分析师（09-data-analyst）
...
## 十三、运营策划师承载（10-ops-strategist）

> 本节为 v2.4 新增，对应 [orchestration.md](orchestration.md) v1.3 的 Step 9 运营策略注入。

### 运营策划师（10-ops-strategist）
...
| **P0 必备** | 爆款标题公式库 | 标题工程师 | 📚 内置 | 8 大标题公式，Step 5.5 核心能力 |
| **P0 必备** | 四维归因分析 | 数据分析师 | 📚 内置 | 选题/标题/内容/时间归因，Step 13 核心能力 |
| **P0 必备** | 策略迭代引擎 | 数据分析师 | 📚 内置 | 四方向优化建议，反馈闭环核心 |
| **P0 必备** | CTA 模板库 | 运营策划师 | 📚 内置 | 关注/在看/转发/评论各 5 种风格 |
| **P0 必备** | 系列化内容规划 | 运营策划师 | 📚 内置 | 系列主题设计+节奏控制 |
...
当前版本：v2.4（新增十一、十二、十三节：标题工程师 08-title-engineer、数据分析师 09-data-analyst、运营策划师 10-ops-strategist 三个新角色技能索引，对应 orchestration.md v1.3 的 Step 5.5 / Step 9 / Step 13 三个新工作流节点；v2.2 基础上新增 taste-skill 条目【P0 必备 · 引用状态】+ 附录「taste-skill 接入说明」含 14 子技能概览 + 3 设置拨盘，吸收自 main 分支 skills/_imported/taste-skill/，cross-learning 2026-07）
